...
public enum ShopsProvider {
    ...
    EXCELLENTSHOP("ExcellentShop", null) {
        ...
        protected IShopsBridge createInstanceInternal(Plugin plugin) throws Exception {
            ...
            if(isClassLoaded("su.nightexpress.excellentshop.api.transaction.ERawTransaction")) {
                excellentShopClass = Class.forName("com.bgsoftware.common.shopsbridge.ShopsBridge_ExcellentShop5_0");
            } else if (isClassLoaded("su.nightexpress.nexshop.product.content.ProductContent")) {
                excellentShopClass = Class.forName("com.bgsoftware.common.shopsbridge.ShopsBridge_ExcellentShop4_20");
            } else if (isClassLoaded("su.nightexpress.nexshop.shop.virtual.impl.VirtualProduct")) {
