...
public class ShopsBridge_Essentials2_16 implements PricesAccessorNoTransactions, IShopsBridge {
    ...
    public BigDecimal getSellPriceInternal(ItemStack itemStack) {
        Worth worth = this.plugin.getWorth();
        BigDecimal price = worth.getPrice(this.plugin, itemStack);
