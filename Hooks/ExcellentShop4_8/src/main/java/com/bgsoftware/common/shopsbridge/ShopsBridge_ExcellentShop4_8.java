...
public class ShopsBridge_ExcellentShop4_8 implements IShopsBridge {
    ...
    private static class TransactionImpl extends AbstractTransaction {
        ...
        private static final ExcellentShop excellentShop = JavaPlugin.getPlugin(ExcellentShop.class);
        ...
        public void onTransact() {
            ...
            su.nightexpress.nexshop.api.shop.Transaction transaction = new su.nightexpress.nexshop.api.shop.Transaction(
                    excellentShop, this.product, tradeType, getItem().getAmount(), getPrice().doubleValue(),
